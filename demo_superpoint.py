...
class VideoStreamer(object):
  ...
  """
    ...
    """
        ...
        return (input_image, True, Path(image_file).stem)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # Get a new image.
        img, status, file_name = vs.next_frame()
        ...
        print('Num keypoints:', len(pts.T))
        img = (img * 255).astype(np.uint8)
        for point in pts.T:
            img = cv2.circle(img, tuple(point[:2].astype(int)), 1, (255, 0, 0), -1)
        ...
        print('Number of matches:', len(tracks))
